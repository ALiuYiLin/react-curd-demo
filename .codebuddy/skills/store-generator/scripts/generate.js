 ...
 * 
 * 用法: node .codebuddy/skills/store-generator/scripts/generate.js <storeName>
 * 示例: node .codebuddy/skills/store-generator/scripts/generate.js user
 * 
 * 读取 config/store/<storeName>.csv
 * 使用 .codebuddy/skills/store-generator/templates/ 下的 hbs 模板
 * 输出到 .codebuddy/skills/store-generator/output/<storeName>/
 */
...
const CONFIG_DIR = path.join(ROOT_DIR, 'config/store');
...
if (!storeName) {
  console.log('用法: node generate.js <storeName>');
  console.log('示例: node generate.js user');
  process.exit(1);
}
